...
function toonProfiel() {
    ...
    if (naam || email || leeftijd || kleur || opgeslagenOp) {
...
function init() {
    ...
    document.getElementById('opslaan-knop').addEventListener('click', slaProfielOp);
    document.getElementById('wissen-knop').addEventListener('click', wisProfiel);
}
